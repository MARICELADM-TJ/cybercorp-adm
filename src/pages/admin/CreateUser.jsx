...
const CreateUser = () => {
  ...
  const handleChange = (e) => {
    ...
    // Manejo especial para la contraseña por defecto
    if (name === "porDefecto") {
  ...
  const handleSaveUser = async (e) => {
    ...
    // Guarda las credenciales del usuario administrador
    ...
    try {
      ...
      // Agrega la información adicional del usuario en Firestore
